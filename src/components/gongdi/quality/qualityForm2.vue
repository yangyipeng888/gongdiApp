    ...
    data() {
      ...
      return {
        ...
        echarts1_option: {
          ...
          //X轴信息
          xAxis: [{
            type: 'category', data: ['2019-10', '2019-12', '2020-02', '2020-03', '2020-05'],
            axisLabel: {
              fontSize: fontSize,
              fontFamily: '微软雅黑',
              marginTop: '35px',
          ...
          series: [{
            name: '数量', type: 'bar', itemStyle: {
              normal: {
                color: function(params) {                        // 给出颜色组                        var colorList = ['#cca272','#74608f','#d7a02b','#c8ba23',];
